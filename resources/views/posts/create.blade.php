...
<!-- テンプレ選択コンテナ -->
    ...
    <div class="modal-content">
        <h3>タイトルを入力してください</h3>
            <!-- タイトル入力欄 -->
            <input type="text" value="" name="title" placeholder="タイトルを入力" required>
        ...
        <!-- プレイヤーはここに配置される（JSでドラッグ&ドロップ） -->
            ...
            <div class="player" data-id="1" data-x="-120" data-y="20" style="transform: translate(-120px, 20px);">
                <div class="player-circle" data-id="team1-1">
                    <input type="text" value="" class="player-number"  placeholder="番号" > <!-- 背番号用テキストボックス -->
                </div>
                
                <div class="player-info">
                    <input type="text" value="" class="player-name" placeholder="選手名" ><!-- 選手名用テキストボックス -->
                </div>
            </div>
            ...
            <div class="player" data-id="11" data-x="-630" data-y="20" style="transform: translate(-630px, 20px);">
                ...
                <div class="player-info">
                    <input type="text" value="" class="player-name" placeholder="GK選手名" ><!-- 選手名用テキストボックス -->
                </div>
            </div>
            ...
            <div class="player" data-id="21" data-x="420" data-y="20" style="transform: translate(410px, 20px);">
